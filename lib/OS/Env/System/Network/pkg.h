...
#ifndef __XC_OS_ENV_SYSTEM_NETWORK__

#include "types.h"
#define SocketType 	os_Env_Network_Socket_Type
#define SocketAddress 	os_Env_Network_Socket_Address
#define NetObjInfo 	os_Env_Network_Object_Info
