...
#ifndef __XC_OS_SYSTEM_STORAGE__
...
Interface(Storage,
  ...
  submodule(Filesys,
	values(Event, word,
		...
		errvt fn(changePerms) (std_FSPath path, os_Sys_User_Permissions perms);
	    	errvt fn(changeOwner) (std_FSPath path, os_Sys_User_Handle user);
  );	
