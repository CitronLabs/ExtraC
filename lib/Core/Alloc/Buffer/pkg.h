...
Class(Buffer,
INIT(u64 size; std_typeData type; bool isStatic; void* initData),
FMT(),
private(
	std_typeData type;
...
@return ERR_NONE if 
*/
      	errvt 		method(Buffer, cast, std_typeData type);
...
@return ERR_NONE if 
*/
      	std_Buffer* 	method(Buffer, fromView, void* start, std_typeData type, u64 len);
};
