...
#define isupper(c) std.String.Utils.Char.isUpper(c)
#define islower(c) std.String.Utils.Char.isLower(c)

#define toupper(c) std.String.Utils.Char.toUpper(c)
#define tolower(c) std.String.Utils.Char.toLower(c)
